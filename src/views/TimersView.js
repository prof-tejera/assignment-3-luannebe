 ...
 useEffect(() => {
    ...
    if (isRunning) {
      ...
      if ( timerType === 'stopwatch') {
        if (currentTime === 0 ) { setCurrentTime(1) };
        timerId = setInterval(() => {
  ...
  }, [isRunning, currentTime, currentRound, restLength, rounds, timerType, workoutLength]);
  ...
  return (
    <AppContext.Provider value={ { mode, setMode, currentTime, setCurrentTime, currentRound, setCurrentRound, seconds, setSeconds, minutes, setMinutes, hours, setHours, restMinutes, setRestMinutes, restSeconds, setRestSeconds, rounds, setRounds, isRunning, setIsRunning, isRestPeriod, setIsRestPeriod, onStart, onStartStopwatch, onStartXY, onStartTabata, onStop, togglePause, handleRepeatTimer, workoutLength, setWorkoutLength, restLength, setRestLength, handleChangeSec, handleChangeMinutes, handleChangeHours, handleChangeRestMinutes, handleChangeRestSec, handleChangeRounds  } } >
      <Container>
        <Nav>
